...
/**
 * Game On Olympics — app-style UI primitives.
 *
...
export const BOOKING_STEPS = [
  { id: "slot", label: "Slot", href: "/gameon-olympics/book/slot" },
  { id: "details", label: "Details", href: "/gameon-olympics/book/details" },
  { id: "review", label: "Review", href: "/gameon-olympics/book/review" },
  { id: "payment", label: "Payment", href: "/gameon-olympics/book/payment" },
] as const;
