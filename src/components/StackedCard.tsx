...
export function StackedCard({
  ...
  const topShadow = useTransform(
    ...
    [
      ...
      `0 -2px 0px rgba(243,143,47,0.03), 0 -4px 20px -10px rgba(0,0,0,${0.2 + (index / totalCards) * 0.2})`,
      `0 -2px 0px rgba(243,143,47,0.04), 0 -8px 30px -12px rgba(0,0,0,${0.25 + (index / totalCards) * 0.35})`,
    ]
  );
