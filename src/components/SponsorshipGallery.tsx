      ...
      <ul className="mx-auto flex max-w-6xl flex-col gap-5 px-6 sm:px-8 lg:gap-7 lg:px-10">
        {slides.map((slide, i) => (
          ...
          >
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden rounded-[24px] border border-white/[0.08] bg-go-navy-glass shadow-[0_12px_45px_-22px_rgba(0,0,0,0.9)] transition-all duration-500 group-hover:border-go-brand/30 group-hover:shadow-[0_24px_70px_-26px_rgba(245,166,35,0.4)]">
                <Image
                  src={slide.src}
                  alt={slide.alt}
                  fill
