...
/**
 * Game On Olympics — step 3: review.
 *
...
export default function OlympicsReviewPage() {
  ...
  const { draft, ready, sport, category, pricing, applyCoupon, removeCoupon } = useOlympicsBooking();
  ...
  return (
    <div>
      ...
      <ScreenHeader
        ...
        backHref="/gameon-olympics/book/details"
      />
      ...
      <Panel className="mb-3">
        <div className="flex items-start gap-3">
          ...
          <Link
            href="/gameon-olympics/book/slot"
      ...
      <Panel className="mb-3">
        <div className="flex items-start justify-between gap-3">
          ...
          <Link
            href="/gameon-olympics/book/details"
      ...
      <StepFooter>
        <div className="flex items-center gap-3 lg:justify-between">
          ...
          <Button
            onClick={() => router.push("/gameon-olympics/book/payment")}
            size="lg"
