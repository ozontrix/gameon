...
/**
 * Game On Olympics — step 1: date + match slot.
 *
...
export default function OlympicsSlotPage() {
  ...
  const { draft, ready, sport, category, update } = useOlympicsBooking();
  ...
  return (
    <div>
      ...
      <ScreenHeader
        ...
        backHref={sport ? `/gameon-olympics/sports/${sport.id}` : "/gameon-olympics/sports"}
        right={
          category ? (
      ...
      <StepFooter>
        <div className="flex items-center gap-3 lg:justify-between">
          ...
          <Button
            onClick={() => router.push("/gameon-olympics/book/details")}
            disabled={!draft.slot}
            size="lg"
